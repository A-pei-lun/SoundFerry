写在一切之前，
相较于Windows的方便，安卓的软件开发还是要复杂点的，可能这就是导致安卓端的语音转文字服务出现极端的原因吧，好的死鬼（毕竟服务对象基本企业级），免费的难用，破解还不方便。所以我萌生了自己写一个可以高度自定义的语音转文字的软件，或者说平台，而这，便是整个项目的初衷。
下面，有请大D老师代我为大家讲解！
# 声渡 SoundFerry 🎤
...
- **v0.9** ✅ 当前 MVP — 录音 → 转写 → 翻译，核心链路跑通
- **v1.0** 🔜 Sherpa-ONNX 多引擎 + 翻译开关补全 + 英文体验优化
- **v2.0** 🤷 还没想好，大概率 UI 重做
